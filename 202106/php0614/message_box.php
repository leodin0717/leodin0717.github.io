   ...
   <table border="0">
    ...
    <?php
	    if ($total_page>=2 && $page >= 2) {
	        $new_page = $page-1;
	        echo "<a href='message_box.php?mode=$mode&page=$new_page'>◀ 이전</a> ";
	    }		
	    else echo "&nbsp";
   	    ...
   	    if ($total_page>=2 && $page != $total_page) {
		    $new_page = $page+1;	
		    echo "<a href='message_box.php?mode=$mode&page=$new_page'>다음 ▶</a>";
	    }
	    else echo "&nbsp";
    ?>
    <br><br>
	<button onclick="location.href='message_box.php?mode=rv'"> 수신 쪽지함</button> &nbsp
	<button onclick="location.href='message_box.php?mode=send'"> 송신 쪽지함</button> &nbsp
